...
function CGV() {
    return (
        <section>
            <Helmet>
                <title>Arvalia | CGV</title>
                <meta name="og:site_name" content="Conditions Générales de Ventes"></meta>
            </Helmet>
            <main className="cgu">
                ...
                <article className="cg-item" id="Loi-Applicable-et-Juridiction">
                    <h1>Ⅹ. Loi Applicable et Juridiction</h1>
